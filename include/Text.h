...
public:
  ...
  void update(float deltaTime) override {
    ...
    // spriteRect.x = GameManager::screen_change_scale * (box->getPosition().x)
    // + GameManager::currentWindowSize.x/2; spriteRect.y =
    // GameManager::screen_change_scale * (box->getPosition().y) +
