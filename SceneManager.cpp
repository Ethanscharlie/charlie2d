...
int SceneManager::originalWidth = 1920;
int SceneManager::originalHeight = 1080;
int SceneManager::windowWidth =  SceneManager::originalWidth;
int SceneManager::windowHeight = SceneManager::originalHeight;

float SceneManager::screen_change_scale = ((float) windowWidth + (float) windowHeight)
    / (originalWidth + originalHeight);


SDL_Window* SceneManager::window = SDL_CreateWindow("SDL2 works!", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, windowWidth, windowHeight, SDL_WINDOW_SHOWN);
SDL_Renderer* SceneManager::renderer = SDL_CreateRenderer(window, -1, SDL_RENDERER_ACCELERATED);
