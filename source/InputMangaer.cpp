...
Vector2f InputManager::getMousePosition() {
    ...
    return {mouseX / GameManager::screen_change_scale + GameManager::camera.position.x - GameManager::originalWidth/2,
           mouseY / GameManager::screen_change_scale + GameManager::camera.position.y - GameManager::originalHeight/2};
}
