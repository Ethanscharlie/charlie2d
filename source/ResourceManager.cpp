...
SDL_Texture* ResourceManager::getColoredTexture(std::array<Uint8, 3> color, std::string textureName) {
    std::string name = std::to_string(color[0]) + " " + std::to_string(color[1]) + " " + std::to_string(color[2]) + " " + textureName;
