...
Vector2f InputManager::getMouseUIPosition() {
    //return {GameManager::screen_change_scale * (entity->require<entityBox>()->getPosition().x) + GameManager::currentWindowSize.x/2, 
    //GameManager::screen_change_scale * (entity->require<entityBox>()->getPosition().y) + GameManager::currentWindowSize.y/2};    
